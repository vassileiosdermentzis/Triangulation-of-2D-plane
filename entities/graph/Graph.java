...
import entities.arraySet.ArraySet;
import java.util.Collections;
import java.util.HashMap;
import java.util.Map;
import java.util.Set;

/** h xrisi twn grafwn krinetai aparaititi gia ton entopismo simeiwn.
 *  Me tin voi8eia twn pinakwn sto arraySet, apla mas voi8aei na diatiroume
 *  kapoia xrisima stoixeia, ka8ws kai ston pio efkolo sxediasmo tis efarmogis
 * @param <N> 
 */

public class Graph<N> {

    private Map<N, Set<N>> theNeighbors = new HashMap<N, Set<N>>();// Node -> adjacent nodes
    private Set<N> theNodeSet = Collections.unmodifiableSet(theNeighbors.keySet());// Set view of all nodes
