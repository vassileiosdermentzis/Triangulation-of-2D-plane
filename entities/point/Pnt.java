package entities.point;


/**
 * Milwntas panta gia simeia entos Euclideiou peidiou, ylopoii8ikan ws double[].
 *
 * Edw 8a ginoun oi gewmetrikew efarmoged gia tin evresi peri3, entos kai diagwnios.
 */
public class Pnt {
    ...
    /**
     * Doulevei gia ka8e diastasi. H e3iswsi einai tis morfis
     * Ax + By + Cz + D = 0
